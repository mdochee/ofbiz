 ...
 *         &lt;element name="OrderShipDate" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="OrderShipCarrier" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="OrderShipMethod" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="OrderTrackingNumber" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="OrderNote" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="OrderItem" type="{}OrderItemType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OrderStatusType {
    ...
    @XmlElement(name = "OrderShipDate", required = true, defaultValue = "")
    protected String orderShipDate;
    @XmlElement(name = "OrderShipCarrier", required = true, defaultValue = "")
    protected String orderShipCarrier;
    @XmlElement(name = "OrderShipMethod", required = true, defaultValue = "")
    protected String orderShipMethod;
    @XmlElement(name = "OrderTrackingNumber", required = true, defaultValue = "")
    protected String orderTrackingNumber;
    @XmlElement(name = "OrderNote", required = true, defaultValue = "")
