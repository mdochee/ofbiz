 ...
 *         &lt;element name="PlpSmallImage" type="{}PlpSmallImageType"/>
 *         &lt;element name="PlpSmallAltImage" type="{}PlpSmallAltImageType"/>
 *         &lt;element name="PdpThumbnailImage" type="{}PdpThumbnailImageType"/>
 *         &lt;element name="PdpLargeImage" type="{}PdpLargeImageType"/>
 *         &lt;element name="PdpDetailImage" type="{}PdpDetailImageType"/>
 *         &lt;element name="PdpVideoImage" type="{}PdpVideoType"/>
 *         &lt;element name="PdpVideo360Image" type="{}PdpVideo360Type"/>
 *         &lt;element name="PdpAlternateImage" type="{}PdpAlternateImageType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ProductImageType {
    ...
    @XmlElement(name = "PlpSmallImage", required = true)
    protected PlpSmallImageType plpSmallImage;
    @XmlElement(name = "PlpSmallAltImage", required = true)
    protected PlpSmallAltImageType plpSmallAltImage;
    @XmlElement(name = "PdpThumbnailImage", required = true)
    protected PdpThumbnailImageType pdpThumbnailImage;
    @XmlElement(name = "PdpLargeImage", required = true)
    protected PdpLargeImageType pdpLargeImage;
    @XmlElement(name = "PdpDetailImage", required = true)
    protected PdpDetailImageType pdpDetailImage;
    @XmlElement(name = "PdpVideoImage", required = true)
    protected PdpVideoType pdpVideoImage;
    @XmlElement(name = "PdpVideo360Image", required = true)
    protected PdpVideo360Type pdpVideo360Image;
    @XmlElement(name = "PdpAlternateImage", required = true)
