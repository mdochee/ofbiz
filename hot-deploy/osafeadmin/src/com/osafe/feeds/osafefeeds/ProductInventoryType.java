 ...
 *         &lt;element name="BigfishInventoryWarehouse" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ProductInventoryType", propOrder = {
    "bigfishInventoryTotal",
    "bigfishInventoryWarehouse"
})
public class ProductInventoryType {

    @XmlElement(name = "BigfishInventoryTotal", required = true, defaultValue = "")
    protected String bigfishInventoryTotal;
    @XmlElement(name = "BigfishInventoryWarehouse", required = true, defaultValue = "")
