  ...
  <div class="entryRow">
    <div class="entry long">
      ...
      <div class="entryInput checkbox">
        ...
        <input type="checkbox" class="srchByName" name="srchByName" id="srchByName" value="Y" <#if parameters.srchByName?has_content || ((intiCb?exists) && (intiCb == "N"))>checked</#if>/>${uiLabelMap.NameLabel}
        ...
        <input type="checkbox" class="srchByValue" name="srchByValue" id="srchByValue" value="Y" <#if parameters.srchByValue?has_content || ((intiCb?exists) && (intiCb == "N"))>checked</#if>/>${uiLabelMap.ValueLabel}
      </div>
    </div>
  </div>
<!-- end searchBox -->
