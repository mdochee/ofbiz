<div class="detailEntryButton">
    <input type="button" class="standardBtn dateSelect" name="insertButton" id="insertButton" value="${uiLabelMap.InsertBtn}" onClick="javascript:insertRow('${detailEntryTable}');"/>
