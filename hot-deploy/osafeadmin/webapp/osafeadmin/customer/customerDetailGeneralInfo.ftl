            ...
            <div class="infoValue">
                <#if (method?has_content)>
                    <select name="exportStatus" class="short">
                        <option value="N" <#if IS_DOWNLOADED?has_content && IS_DOWNLOADED.equals("N") >selected=selected</#if>>${uiLabelMap.DownloadNewInfo}</option>
                        <option value="Y" <#if IS_DOWNLOADED?has_content && IS_DOWNLOADED.equals("Y") >selected=selected</#if>>${uiLabelMap.ExportStatusInfo}</option>
                    </select>
                <#else>
            ...
            <div class="infoValue">
                <#if (method?has_content)>
                    <select name="emailPreference" class="short">
                        <option value="HTML" <#if PARTY_EMAIL_PREFERENCE?has_content && PARTY_EMAIL_PREFERENCE.equals("HTML") >selected=selected</#if>>${uiLabelMap.HtmlEmailPreferenceInfo}</option>
                        <option value="TEXT" <#if PARTY_EMAIL_PREFERENCE?has_content && PARTY_EMAIL_PREFERENCE.equals("TEXT") >selected=selected</#if>>${uiLabelMap.TextEmailPreferenceInfo}</option>
                    </select>
                <#else>
