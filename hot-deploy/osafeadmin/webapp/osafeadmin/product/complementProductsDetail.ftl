      ...
      <#list compProductAssoc as relatedProduct>
        ...
        <#assign productContentWrapper = Static["org.ofbiz.product.product.ProductContentWrapper"].makeProductContentWrapper(relatedProdDetail, request)!""/>
         ...
         <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
           ...
           <td class="seqCol">
             <input type="text" class="infoValue small textAlignCenter" name="compSequenceNum_${rowNo}" id="compSequenceNum" value="${relatedProduct.sequenceNum!}"/>
           </td>
      ...
      <#list 1..minRow as x>
        <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
           ...
           <td class="seqCol">
             ...
             <input type="text" class="infoValue small textAlignCenter" name="compSequenceNum_${x}" id="compSequenceNum" value="${sequenceNum!}"/>
           </td>
           <#assign productName = Static["com.osafe.util.OsafeAdminUtil"].formatSimpleText('${productContentWrapper.get("PRODUCT_NAME")!""}')/>
           <td class="actionCol">
