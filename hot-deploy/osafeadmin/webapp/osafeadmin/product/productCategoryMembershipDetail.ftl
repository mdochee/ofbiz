    ...
    <#if resultList?exists && resultList?has_content && !parameters.totalRows?exists>
        <#list resultList as productCategoryAndMember>
            ...
            <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
               ...
               <td class="actionCol">
                   <a href="javascript:setRowNo('${rowNo}');javascript:deleteCategoryMemberRow('${productCategoryAndMember.categoryName!""}', '${primaryProductCategory.categoryName!""}');" onMouseover="javascript:showTooltip(event,'${uiLabelMap.DeleteCategoryMemberTooltip}');" onMouseout="hideTooltip()"><span class="crossIcon"></span></a>
    ...
    <#elseif parameters.totalRows?exists>
        ...
        <#list 1..minRow as x>
            ...
            <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
               ...
               <td class="actionCol">
                   <a href="javascript:setRowNo(${x});javascript:deleteCategoryMemberRow('${productCategory.categoryName!""}', '${primaryProductCategory.categoryName!""}');" onMouseover="javascript:showTooltip(event,'${uiLabelMap.DeleteCategoryMemberTooltip}');" onMouseout="hideTooltip()"><span class="crossIcon"></span></a>
