...
rem ###VM args block ####################################################
rem set MEMIF=-Xms512M -Xmx512M -XX:MaxPermSize=128m
rem # RMI settings
...
rem "%JAVA_HOME%\bin\java" -Xms512M -Xmx512M -XX:MaxPermSize=128m -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5005 -jar ofbiz.jar > runtime\logs\console.log

rem ### Simple easy to read line
echo on
title OfBiz Big Fish
set SOLR_PARMS=-Dsolr.solr.home=/home/cuong/work/workspace/OpenERP/ofbizGithub/hot-deploy/solr -Dsolr.data.dir=/home/cuong/work/workspace/OpenERP/ofbizGithub/hot-deploy/solr/data
...
rem "%JAVA_HOME%\bin\java" -Xms512M -Xmx512M -XX:MaxPermSize=128m -jar ofbiz.jar > runtime\logs\console.log
